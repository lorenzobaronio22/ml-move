...
- Name: contact.spec.ts >> contact form >> contact page renders the form
- Location: src/test/contact.spec.ts:4:3
...
Call log:
  ...
  - waiting for locator('#contact-form')
